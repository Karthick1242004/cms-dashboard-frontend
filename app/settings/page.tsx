                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">Notifications about low stock levels</p>
                    </div>
                    <Switch checked={inventoryAlerts} onCheckedChange={setInventoryAlerts} />
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      <Label>Work Order Alerts</Label>
                      <p className="text-sm text-muted-foreground">Notifications about work order status changes</p>
                    </div>
                    <Switch checked={workOrderAlerts} onCheckedChange={setWorkOrderAlerts} />
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Connect to your human resources system</p>
                    </div>
                  </div>
                  <Button variant="outline">Connect</Button>
                </div>
